...
# Terminales con protocolo kitty: si el emulador deja escapar W+modificador como
# secuencia CSI-u en vez de ^W, ejecutar el dialogo Si/No. Se cubren las
# codificaciones de ctrl+w (5u/7u/23), super+w (9u/13u; algunos teclados/VMware
# envian super en lugar de ctrl) y el legacy 9;9u.
...
bind -x '"\e[119;9u": /usr/local/bin/whitehatso-close'  2>/dev/null
bind -x '"\e[87;9u":  /usr/local/bin/whitehatso-close'  2>/dev/null
bind -x '"\e[119;13u": /usr/local/bin/whitehatso-close' 2>/dev/null
